...
import {MessageSquare, User,Mail,Lock,EyeOff ,Loader2,Eye} from "lucide-react";
...
const SignupPage = () => {
    ...
    const validateForm=()=>{
        ...
        if(!/\S+@\S+\.\S+/.test(formData.email)) return toast.error("email invalid");
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
     {/* for  leftside */}
     <div className="flex flx-col ustify-center items-center p-6 sm:p-12">
